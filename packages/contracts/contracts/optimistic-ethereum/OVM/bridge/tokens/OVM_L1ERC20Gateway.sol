...
contract OVM_L1ERC20Gateway is iOVM_L1TokenGateway, OVM_CrossDomainEnabled {
     ...
     */
    function deposit(uint _amount) external override virtual
    {
     ...
     * @param _amount Amount of the ERC20 to deposit
     */
    function depositTo(address _to, uint _amount) external override virtual
    {
     ...
     * @param _amount Amount of the ERC20 to deposit.
     */
    function _initiateDeposit(address _from, address _to, uint _amount) internal
    {
        ...
        sendCrossDomainMessage(l2DepositedToken, data, getFinalizeDepositL2Gas());
     ...
     */
    function finalizeWithdrawal(address _to, uint _amount) external override virtual
